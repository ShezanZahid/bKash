	        ...
	        <div class="card-body">
		        <div class="row">
		            ...
		            <div class="col-md-8 form-group" >
		                <input class="form-control " name="name" style="width: 100%;" value="{{$journal->name}}" >
		            ...
		            <div class="col-md-8  form-group">            
                        <div class="mb-3">
                            <textarea class="textarea" name="description" placeholder="Place some text here" >{{$journal->description}}</textarea>
                    ...
                    <div class="col-md-3 form-group col-form-label text-md-center">
							...
							<div class="col-md-8 form-group">
								...
								<div class="custom-file">
									...
									<label class="custom-file-label" for="imgInp">{{$journal->image}}</label>
									{!! $errors->first('image', '<p class="error-message">:message</p>') !!}
								</div>
								
								<br>
								<img id='img-upload' name='uploadImage' class="rounded mx-auto d-block" width="650" src="{{ asset('journal-docs/images/'.$journal->image )}}" style="margin-top:15px" />
							</div>
							...
							<div class="col-md-8 form-group" >
								<div class="custom-file">
									...
									<label class="custom-file-label" for="imgInp">{{$journal->file}}</label>
