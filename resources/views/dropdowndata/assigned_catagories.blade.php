 ...
 @section('title','| Approved assigned Upload')
 @section('content')
 ...
 <div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Assigned Group Catagories</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item a"><a href="{{route('approvedprocess.index')}}">Approved Process List</a></li>
        </ol>
      </div>
    </div>
    <!-- /.container-fluid -->
  		...
  		<div class="card card-default">
              ...
              <table class="table table-bordered table-striped" >
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="align-middle text-center" style="width: 10%">{{$assignedcatagory->id}}</td>
                    <td class="align-middle text-center" style="width: 40%">{{$assignedcatagory->name}}</td>
                   ...
                   <td class="align-middle text-center" style="width: 15%">
                     ...
                     <a class="btn btn-danger btn-xs" href="{{route('assignedcatagory.status',$assignedcatagory->id)}}">OFF 
                    </a>

                    @else

                    <a class="btn btn-success btn-xs" href="{{route('assignedcatagory.status',$assignedcatagory->id)}}">
                      ON
                    </a>
                  ...
                  <td class="align-middle text-center" style="width: 20%">
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        <form method="Post" action="{{ route('assignedcatagory.destroy',$assignedcatagory->id) }}">
                          {{method_field('DELETE')}}
                          {{csrf_field()}}
          ...
          <div class="col-md-4">
            <div class="card border-dark mb-3" style="max-width: 100%;">
             ...
             <div class="card-body text-dark">
              <p class="card-text">
               <form method="Post" action="{{route('assignedcatagory.store')}}">
                @csrf
